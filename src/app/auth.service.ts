...
export class AuthService {
  ...
  login(usercreds){
    ...
    return new Promise((resolve) => {
      this.http.post('http://learn.it-akademy.fr:8000/oauth/access_token', creds, {headers: headers}).subscribe((data) => {
  ...
  infoUser(){
    return this.http.get('http://learn.it-akademy.fr:8000/api/v1/getUser', {headers: this.headers})
      .toPromise()
